...
const Promotions = () => {
    return (
      <div className="promotions">
        ...
        <Link to="../hamburgownia/product/Cheez Taw">
          <div className="promotions__container">
            ...
            <div className="promotionsCol">
              ...
              <span className="desc">
                Próbowałeś już Cheez burga, ale czy zawsze musisz decydować się
                na jedną rzecz? CheezTaw to idealna opcja dla Ciebie! Ciesz się
                soczystym Cheezburgiem, chrupiącymi frytkami i orzeźwiającym
                napojem - wszystko to w jednym wyjątkowym zestawie, który
                zaspokoi Twoje głodne podniebienie!
              </span>
            </div>
          </div>
        </Link>
